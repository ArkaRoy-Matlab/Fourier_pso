% ***************************************************************
% *** Matlab code for Real Model of Godavari Basin, India
...
% ****************************************************************
%Final Model of Godavari Basin for gravity field and inversion
clear all
close all
...
%t and c are Legendre Gaussian quadrature points for numerical integration
    ...
    title('Depth profile of the synthetic basin (Model 1)')
    box on
    ...
    title('Fourier Power spectrum for Depth Anomaly from Zhou2012')
    xlabel('Coefficients')
    ylabel('Amplitude')
...
%% Problem Definition
%%%%    Optimization of Godavari Basin using PSO     %%%%
c1=1.4; c2=1.7; 
            ...
            save error_energy_godavari best_error -ascii
...
%%%%    Plotting the results for Optimization model    %%%%
     ...
     xlabel('Distance in meter')
     ylabel('Depth in meter')
     legend('Zhou2012','Best Model','location','southeast')
     title('Depth profile of Godavari Basin')
     box on
     subplot(2,1,1)
     hold on
     %Observed 
     ...
     xlabel('Observation points in meter')
     ylabel('Gravity anomaly in mGal')
     title('Gravity anomaly of Godavari Basin ')
