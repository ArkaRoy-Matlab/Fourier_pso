% ***************************************************************
% *** Matlab function for synthetic model-1 with fixed density distribution
...
% ****************************************************************
%Final synthetic 1st model for gravity field and inversion
clear all
close all
...
%t and c are Legendre Gaussian quadrature points for numerical integration
    ...
    title('Gravity anomaly for Model 1 ')
...
c1=1.4; c2=1.7; 
            ...
            save error_energy_mode1_fixed_wo best_error -ascii
...
%%%%    Plotting the results for Optimization model    %%%%
     ...
     title('Depth profile of synthetic basin (Model 1)')
     box on
     subplot(2,1,1)
     hold on
     %Observed 
