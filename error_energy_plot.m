...
%noise free data
y1=importdata('error_energy_mode1_fixed_wo');
y2=importdata('error_energy_mode1_varying_wo');
y3=importdata('error_energy_mode2_fixed_wo');
y4=importdata('error_energy_mode2_varying_wo');

%noisy data
z1=importdata('error_energy_mode1_fixed_w');
z2=importdata('error_energy_mode1_varying_w');
z3=importdata('error_energy_mode2_fixed_w');
z4=importdata('error_energy_mode2_varying_w');
